...
public class ParentServiceImpl implements ParentService {
    ...
    public ParentDTO create(CreatePersonModel model) {
        ...
        String role = Roles.PARENT;
        validateModel(model, role);

        ParentDTO parent = initPopulationOfParent(model, role);
    ...
    private ParentDTO populateParentDTO(ParentDTO parent, CreatePersonModel model) {
        ...
        parent.setPassword(encoder.encode(model.getPassword()));
    ...
    private ParentDTO initPopulationOfParent(CreatePersonModel model, String role) {
